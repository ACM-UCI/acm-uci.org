            ...
            <Container className="p-5">
                ...
                <Row>
                    ...
                    <Col>
                        <Card className={styles.card}>
                            ...
                            <Card.Body>
                                ...
                                <ul>
                                    <li>
                                        <Link href="https://www.youtube.com/@NeetCode">
                                            Neetcode
                                        </Link>
                                    </li>
                                    <li>
                        ...
                        <Card className={styles.card}>
                            ...
                            <Card.Body>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <Link href="https://open.kattis.com">
                                            Kattis
                                        </Link>
                                    </li>
                                    <li>
                                ...
                                <ul>
                                    <li>
                                        <Link href="https://cp-algorithms.com">
                    ...
                    <p>
                        ...
                        <Link href="https://docs.python.org/3/index.html">
                            Python
                        </Link>{" "}
                        and{" "}
                        <Link href="https://cplusplus.com/reference/">C++</Link>{" "}
