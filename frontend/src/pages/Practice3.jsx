...
// NOT using this anymore, I want to display old quarter problems 
/* 
...
export default function Practice3() {
  ...
  const [eventSpace, setEventSpace] = useState("winter");
  const [isFallQuarter, setFallQuarter] = useState(false);
